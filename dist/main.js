...
jquery_bridget__WEBPACK_IMPORTED_MODULE_3___default()('imagesLoaded', (imagesloaded__WEBPACK_IMPORTED_MODULE_4___default()), (jquery__WEBPACK_IMPORTED_MODULE_2___default()));
...
var Site = {
  ...
  fixWidows: function fixWidows() {
    ...
    jquery__WEBPACK_IMPORTED_MODULE_2___default()('.js-fix-widows').each(function () {
      var string = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).html();
      string = string.replace(/ ([^ ]*)$/, '&nbsp;$1');
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).html(string);
    });
  }
};
Site.Enquiry = {
  $forms: jquery__WEBPACK_IMPORTED_MODULE_2___default()('.contact-form'),
  init: function init() {
    var _this = this;
  ...
  bind: function bind() {
    ...
    _this.$forms.on({
      'submit': function submit(e) {
        e.preventDefault();
        var data = jquery__WEBPACK_IMPORTED_MODULE_2___default()(this).serializeArray().reduce(function (obj, item) {
  ...
  submitForm: function submitForm(form, data) {
    ...
    if (data.from === '' || data.copy === '') {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(form).find('input[type=submit]').attr('disabled', 'disabled');
    }
  },
  warnInvalid: function warnInvalid(form) {
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(form).addClass('invalid');
  },
  unwarnInvalid: function unwarnInvalid(form) {
    jquery__WEBPACK_IMPORTED_MODULE_2___default()(form).removeClass('invalid');
  },
  ...
  handleResponse: function handleResponse(response, status, form) {
    ...
    if (response.type === 'error') {
      ...
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(form).addClass('thanks');
    }
  },
  handleError: function handleError(error, form) {
    var $form = jquery__WEBPACK_IMPORTED_MODULE_2___default()(form);
...
Site.Masonry = {
  $container: jquery__WEBPACK_IMPORTED_MODULE_2___default()('#masonry-container'),
  instance: undefined,
  init: function init() {
    var _this = this;
  ...
  createInstance: function createInstance() {
    ...
    _this.instance = new (masonry_layout__WEBPACK_IMPORTED_MODULE_5___default())(_this.$container[0], {
    ...
    _this.$container.find('img').each(function (index, item) {
      jquery__WEBPACK_IMPORTED_MODULE_2___default()(item).on('load', function () {
        _this.instance.layout();
      });
    });
  }
